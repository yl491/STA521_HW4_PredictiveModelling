...
```
\
Answer: As the RMSE for linear model of out of sample prediction is 1381.472, it is not better.\
#NEED ANALYSIS
...
\
Answer: RMSE of simulated replicates under negative binomial model is 1261.002. The RMSE of train data is 1261.002 and the RMSE of test data is 2666.5.
...
for (i in 1:K) {
 ...
 col.train.lm1=lm(Apps~.,data=College.train)
...
results[,4]<-c(mean(lm.coverage),NA,mean(poi.coverage),mean(NB.coverage))
