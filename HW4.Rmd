...
pval.lm4=sum(rm4>rmse.observations)/length(rm4)
pval.lm4
Col.lm.predict4<-predict(col.train.nb,data=College.train,type="response")
rmse.observations<-rmse(College.train$Apps,Col.lm.predict4)
